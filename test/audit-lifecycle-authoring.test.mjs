...
test('client.js registers en + zh dictionaries without ru (#277, #309)', () => {
  assert.ok(CLIENT_SRC.includes('ctx.locale.register(NS, { en, zh })'), 'en + zh source dictionaries must be registered');
