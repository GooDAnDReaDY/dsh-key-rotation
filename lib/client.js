// dsh-key-rotation — Settings card ("Key Rotation" / "Ротация ключей").
  ...
  factory: (require) => {
    ...
    function KeyRotationSection(props) {
      ...
      return h('div', { className: 'krot' },
        ...
        undo ? h('div', { className: 'krot-foot' }, h('span', { className: 'krot-hint' }, undo.type === 'provider' ? t('undoProvider') : t('undoKey')), btn(t('undo'), doUndo, {})) : null,
        h('div', { className: 'krot-foot' },
