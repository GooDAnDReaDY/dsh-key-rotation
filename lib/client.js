...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // UpdaterSection is rendered by KeyRotationSection below, so it must live
    // at factory scope: a function declared inside apply(ctx) is invisible to
    // this module-level-ish component and the render crashed with
    // "ReferenceError: UpdaterSection is not defined" (#2).
